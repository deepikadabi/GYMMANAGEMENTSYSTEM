 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="#" class="w-100 mt-5" method="post" commandName="userLog" >
		<table class=" table table-striped ">
			...
			<tr>
			<td><h5> Package Id :  <%=((User)session.getAttribute("LoggedUser")).getGymPackage().getpId() %></h5></td>
							</tr>
			
							<tr>
     				
							<td><h5>Package Name</h5></td>
							<td> 	<h5> <%=((User)session.getAttribute("LoggedUser")).getGymPackage().getpName() %></h5>			</td>
      						
							<td><h5>Duration</h5></td>
							<td> 	<h5> <%=((User)session.getAttribute("LoggedUser")).getGymPackage().getpMonth() %></h5>			</td>
				...
				<tr>
							<td><h5>Timing</h5></td>
							<td> 	<h5> <%=((User)session.getAttribute("LoggedUser")).getGymPackage().getpTime() %></h5>			</td>

		
		
							<td><h5>Charges</h5></td>
							<td> 	<h5> <%=((User)session.getAttribute("LoggedUser")).getGymPackage().getpCharge() %></h5>			</td>
				</tr>
