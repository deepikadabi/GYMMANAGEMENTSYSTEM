...
<div class="container-fluid d-flex justify-content-center "style="height: 100vh ;
 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="aRegister.htm" class="was-validated w-50 mt-5" method="get" commandName="admin" >
		<table class=" table table-striped ">
		
			<thead>
				<tr  class="text-center text-light">
					<th colspan = "2"  ><h3>Admin Register Page</h3></th>
				</tr>
			</thead>
			<tbody class="text-light">
				<tr>
					<td><h5>UserName</h5></td>
					<td class="form-group"><spr:input type="text" minlength="4" class="form-control is-valid" path="aName" placeholder="Enter username" required="true"/>
				...
				<tr>
					<td><h5>Email</h5></td>
					<td class="form-group"><spr:input type="email" class="form-control is-valid" minlength="10" path="aEmail" placeholder="Enter email" required="true"/>
				...
				<tr>
					...
					<td class="form-group"><spr:password path="aPass" class="form-control" placeholder="Enter password" required="true"/>
		...
		<div class="d-flex row" style="margin-top: 20px; color: white; font-size: 20px">
			...
			<div class="col"><a href="aIndexLogin.htm" style="font-size: 26px; color:white">Login</a></div>
		</div>
	</spr:form>
	</div>
