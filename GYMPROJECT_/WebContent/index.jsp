...
<body style="background-image:url(img.jpg); background-size:cover;background-repeat:no-repeat;background-position:center;">
...
<div class="row flex-column justify-content-center text-light align-items-center" style="height:90vh;">
<h1 style="font-size:15vh;">Welcome</h1>
<h1 style="font-size:8vh; font-family:cursive;">To GYM Management</h1>
