                    ...
                    <div class="col-8 ">
                                ...
                                <div class="col mt-3 mb-3">
                                 ...
                                 <div>
                                   ...
                                   <!--  <div>
                                        <a href=""
                                            class="btn btn-dark  btn-lg btn-block  active" role="button"
                                            aria-pressed="true">Update Member</a>
                                    </div>
                                    <br> -->
                                    <div>
                                        <a href="MemberList.htm"
                                            class="btn btn-dark  btn-lg btn-block  active" role="button"
                                            aria-pressed="true">MemberList</a>
                                    </div>
                                    <br>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="col mt-3 mb-3">
                                    <div>
                                 <div>
                                        <a href="registerPackage.htm" 
                                        class="btn btn-dark btn-lg btn-block  active" role="button" 
                                        aria-pressed="true">Add Package</a>
                                    </div>
                                   
                                    
                                    <br>
                                    <div>
                                        <a href="packageList.htm"
                                            class="btn btn-dark  btn-lg btn-block  active" role="button"
                                            aria-pressed="true">Package List</a>
                                    </div>
                                    <br>
						...
						<div class="row justify-content-center align-items-center d-flex" style="height: 12%;">
								<div>
                                        <a href="UserListWithPackage.htm" 
                                        class="btn btn-dark btn-lg btn-block  active" role="button" 
                                        aria-pressed="true">User List With Packages</a>
                                    </div>
                        </div>
