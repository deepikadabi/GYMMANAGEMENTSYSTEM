...
<div class="container-fluid d-flex justify-content-center "style="height: 100vh ;
 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="pRegister.htm" class="was-validated w-100 mt-5" method="get" commandName="gymPackage" >
		<table class=" table table-striped ">
		
			<thead>
				<tr  class="text-center text-light">
					<th colspan = "4"  ><h3>Add Package</h3></th>
				</tr>
			</thead>
			...
			<tr>
							...
							<td class="form-group"><spr:input type="text" class="form-control is-valid" minlength="4" path="pName" id="validationServer01" required="true"/>						
				...
				<tr>
							...
							<td class="form-group"><spr:input type="text" class="form-control is-valid"  path="pMonth" id="validationServer03" placeholder="Enter Package Duration" required="true"/>						
	      						<div class="invalid-feedback">Enter Package Duration.</div>				
      						</td>
				...
				<tr>
							 <td>
                                                        ...
                                                        <td class="form-group"><select id ="spe" name="pTime" class="form-control is-valid" path="pTime" requied="true">
                                                          <option value=""></option>
                       ...
                       <div class="invalid-feedback">Select Timing</div>				
				...
				<tr>
							<td><h5>Charges</h5></td>													
							<td class="form-group"><spr:input type="text" class="form-control is-valid" path="pCharge" id="validationServer04" placeholder="Enter Charges" required="true"/>						
