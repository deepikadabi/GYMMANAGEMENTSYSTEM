...
<div class="container-fluid d-flex justify-content-center "style="height: 100vh ;
 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="user_update_data.htm" class="w-100 mt-5" method="post" commandName="user" >
		<table class=" table table-striped ">
		
			<thead>
				<tr  class="text-center text-light">
					<th colspan = "4"  ><h3>Update Member</h3></th>
				</tr>
			</thead>
			<tbody class="text-light">
			<tr>
			<td><h5>UserId</h5></td>
							<td class="form-group"><spr:input class="form-control is-valid"  path="uId" id="validationServer01" required="true"/>						
			...
			<tr>
							...
							<td class="form-group"><spr:input type="text" class="form-control is-valid" minlength="4" path="uName" id="validationServer01" required="true"/>						
	      						<div class="invalid-feedback">Please fill out this field.</div>				
      						</td>
      						
							<td><h5>UserNumber</h5></td>
							<td class="form-group"><spr:input type="text" class="form-control is-valid" path="uNum" id="validationServer02" placeholder="Enter Number"/>						
				...
				<tr>
						<!-- 	<td><h5>UserBloodGroup</h5></td>    -->
							 <td>
                                                        ...
                                                        <td class="form-group"><select id ="spe" name="uBloodGroup" class="form-control is-valid" path="uBloodGroup" required="true">
                                                          <option value=""></option>
