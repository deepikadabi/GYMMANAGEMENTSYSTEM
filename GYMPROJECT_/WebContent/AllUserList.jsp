 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	...
	<thead >
				<tr  class="text-center text-light">
					<th colspan = "10"  ><h5>Member List</h5></th>
				</tr>
		...
		<tr style="font-size:2.2vh">
			...
			<td><%=u.getuEmail()%></td>
			<td><%=u.getuAge()%></td>
			<td><%=u.getuBloodGroup()%></td>
			<td><%=u.getuNum()%></td>
			<td><%=u.getuDate()%></td>
			<td><%=u.getuCity()%></td>
			<td><a href="user_delete.htm?uId=<%=u.getuId()%>">Delete</a></td>
			<td><a href="user_update.htm?uId=<%=u.getuId()%>">Update</a></td>	
		</tr>
		<% } %>
