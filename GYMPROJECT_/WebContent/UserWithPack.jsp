 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	...
	<thead >
				<tr  class="text-center text-light">
					<th colspan = "11"  ><h5>Member List</h5></th>
				</tr>

				<tr style="font-size:3vh; color: white">
					<th><h6>Member Id</h6></th>
					<th ><h6>Name</h6></th>
					<th ><h6>Email</h6></th>
					<th ><h6>Contact Number</h6></th>
					<th ><h6>Joining Date</h6></th>
					<th ><h6>Package Id</h6></th>
					<th ><h6>Pack Name</h6></th>
		...
		<tr style="font-size:2.2vh">
			...
			<td><%=u.getuNum()%></td>
			<td><%=u.getuDate()%></td>			
			<td><%=u.getGymPackage()!= null ? u.getGymPackage().getpId() : "N/A" %></td>
			
			<td><%=u.getGymPackage()!= null ? u.getGymPackage().getpName() : "NA"%></td>
			<td><%=u.getGymPackage() != null ? u.getGymPackage().getpMonth() : "NA"%></td>
			<td><%=u.getGymPackage()!= null ? u.getGymPackage().getpTime() : "N/A"%></td>
			<td><%=u.getGymPackage() != null ? u.getGymPackage().getpCharge() : "N/A"%></td>
			<td><a href="removeFromMemberShip.htm?uId=<%=u.getuId()%>">Delete</a></td>
		</tr>
		<% } %>
