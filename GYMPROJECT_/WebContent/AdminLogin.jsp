...
<div class="container-fluid d-flex justify-content-center "style="height: 100vh ;
 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="aLogin.htm" class="was-validated w-50 mt-5" method="post" commandName="adminLog" >
		<table class=" table table-striped ">
		
			<thead>
				<tr  class="text-center text-light">
					<th colspan = "2"  ><h3>Admin Login Page</h3></th>
				</tr>
			</thead>
			<tbody class="text-light">
			<tr>
					<td><spr:hidden path="aName"/>
					</td>
				</tr>
				
				<tr>
					<td><h5>Email</h5></td>
					<td class="form-group"><spr:input type="email" minlength="10" class="form-control is-valid" path="aEmail" id="validationServer03" placeholder="Enter email" required="true"/>
				...
				<tr>
					...
					<td class="form-group"><spr:password path="aPass" minlength="4" class="form-control is-valid" id="validationServer04" placeholder="Enter password" required="true"/>
		...
		<div class="row d-flex justify-content-center align-items-center" style="color: red; "><%=(session.getAttribute("err") != null) ? (session.getAttribute("err")) : ""  %></div>
		...
		<div class="d-flex row" style="margin-top: 20px; color: white; font-size: 20px">
			...
			<div class="col"><a href="aRegister.htm" style="font-size: 26px; color:white">Register</a></div>
		</div>
		...
		<div class="d-flex row justify-content-center align-items-center" style="margin-top: 10px; color: white; font-size: 20px">
			<a href="AdminForgot.html">Forgot Your Password</a>
		</div>
	</spr:form>
	</div>
