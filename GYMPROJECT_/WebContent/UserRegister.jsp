	      ...
	      <li class="nav-item">
	       <div class="dropdown">
			  ...
			  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
			    <a class="dropdown-item" href="uLogin.htm">User</a>
...
<div class="container-fluid d-flex justify-content-center "style="height: 100vh ;
 ...
 background-size:cover;background-position:center; background-repeat:no-repeat">
	<spr:form action="uRegister.htm" class="was-validated w-100 mt-5" method="get" commandName="user" >
		<table class=" table table-striped ">
		
			<thead>
				<tr  class="text-center text-light">
					<th colspan = "4"  ><h3>User Register Page</h3></th>
				</tr>
			</thead>
			<tbody class="text-light">
				<tr>
							...
							<td class="form-group"><spr:input type="text" class="form-control is-valid" minlength="4" path="uName" id="validationServer01" value="" placeholder="Enter username" required="true"/>						
